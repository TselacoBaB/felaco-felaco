    ...
    <div className="flex justify-center w-full pb-6">
      <div className="w-full max-w-4xl px-4 sm:px-4 md:px-8 lg:px-8 xl:px-8" style={{ width: '80%' }}>
        ...
        <div className="px-4 py-6">
          ...
          {/* Show Become a Creator button only for users with 'user' role and not pending/approved creators */}
          {userRole === 'user' && (
            <div className="mt-4">
              <Link to="/creator-application">
                <Button className="w-full bg-felaco-purple text-white font-semibold rounded-full py-3">
                  Become a Creator
                </Button>
              </Link>
            </div>
        ...
        <div className="border-t border-gray-200">
          ...
          <div className="mt-1 px-1">
            {activeTab === 'posts' && <Feed userId={user?.id} />}
            {activeTab === 'reels' && (
...
// Remove any dashboard or random navigation logic. This Profile page should not redirect or navigate anywhere except via explicit user actions (e.g., clicking a Link or Button).
